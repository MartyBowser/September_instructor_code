...
In the reading material, you were introduced to Vue. In this tutorial, you'll write your first Vue Component and add it to an existing project. The project is located in this directory.
...
Now start with building the markup for this component. You'll build out a todo list. You can copy and paste the following code inside of the `<template></template>` tag:
...
Next, create an empty array inside the return of the data function:
...
Then take the list items that you used before and add them to the todo array:
